...
def generate_random_deterministic_automata(automaton_type,
    ...
    while queue:
        ...
        for i in input_alphabet:
            ...
            if bSafety and state.is_accepting:
...
def generate_random_dfa(num_states, alphabet, num_accepting_states=1,safety=False,ensure_minimality=True,
                        compute_prefixes=False) -> Dfa:
    """
